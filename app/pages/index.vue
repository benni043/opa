    ...
    <div class="w-full max-w-4xl">
      ...
      <UForm :schema="schema" :state="state" @submit="onSubmit">
        <div class="grid grid-cols-2 gap-8">
          ...
          <div class="space-y-4">
            ...
            <div>
              ...
              <UButton size="xs" class="mt-2" @click="addLanguage">+ Sprache</UButton>
              ...
              <div class="max-h-60 overflow-y-auto">
                ...
                >
                  ...
                  <UInput v-model.number="lang.speakers" type="number" placeholder="Anzahl"/>
                  <UButton size="xs" color="error" @click="removeLanguage(i)">X</UButton>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <UButton size="xs" class="mt-2" @click="addOrganization">+ Organisation</UButton>
              ...
              <div class="max-h-60 overflow-y-auto">
                <div
                  ...
                  class="flex gap-2 mt-2"
                >
                  <UInput v-model="state.organizations[i]" :placeholder="'Organisation ' + (i + 1)"/>
                  <UButton size="xs" color="error" @click="removeOrganization(i)">X</UButton>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="flex justify-center">
          <UButton size="lg" type="submit" class="mt-6">
            Bestätigen
          </UButton>
        </div>
